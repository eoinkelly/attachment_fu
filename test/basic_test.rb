...
class BasicTest < Test::Unit::TestCase
  ...
  def test_should_normalize_content_types_to_array
    ...
    assert_equal AttachmentFu::AttachmentFu.content_types, ImageAttachment.attachment_options[:content_type]
    assert_equal ['pdf'] + AttachmentFu::AttachmentFu.content_types, ImageOrPdfAttachment.attachment_options[:content_type]
  end
